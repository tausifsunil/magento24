define([
    ...
    $.widget('mage.foreverRenerQuickViewButton', {
        options: {},
        textElement: null,
        parent: null,
        ...
        _create: function () {
            ...
            if (this.element.attr('forever-quickview-js-observed')) {
                // alert('in if');
                return;
            }
            this.element.attr('forever-quickview-js-observed', 1);

            var items = this.element.parent().find(this.getPriceSelector());
            if (items.length) {
                // console.log('her 545454');
            ...
            this.textElement = this.element.find('.forever-quickview-text');
        ...
        setButtonPosition: function () {
            var className = 'forever-quickview-position-' + this.options.position
            ...
            if (wrapper.length) {
                ...
                var parent = this.element.parent();
                if (parent.hasClass('forever-quickview-position-wrapper')) {
                    parent.parent().append(this.element);
                }

                this.element.wrap("<div class='" + className + ' forever-quickview-position-wrapper' + "'></div>");
    ...
    return $.mage.foreverRenerQuickViewButton;
});
