...
class File extends AbstractBackend
{
    ...
    public function beforeSave($object)
    {
        ...
        // $delete = $object->getData($this->getAttribute()->getName() . '_additional_data');
        // echo "<pre>"; print_r($object->getData($this->getAttribute()->getName())); die();
