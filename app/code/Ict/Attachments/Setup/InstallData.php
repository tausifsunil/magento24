...
/*namespace Ict\Attachments\Setup;
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'input' => 'file',
                // 'backend' => \Ict\Attachments\Model\Attribute\Backend\Product\File::class,
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context) {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'input' => 'file',
                'backend' => 'Ict\Attachments\Model\Product\Attribute\Backend\File',
                'frontend' => '',
                'class' => '',
                'source' => '',
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_GLOBAL,
        ...
        foreach ($attributeSetCollection as $attributeSet) {
            $eavSetup->addAttributeToSet("catalog_product", $attributeSet->getAttributeSetName(), "General", "product_attachment");
        }
    }
}