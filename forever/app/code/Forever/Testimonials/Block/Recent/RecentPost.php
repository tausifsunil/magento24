...
class RecentPost extends Template
{
    ...
    public const RECENT_POST = 'testimonials/recent_testimonials/number_recent_posts';
    /**
     *
    ...
    {
        $collection = $this->testimonialsCollection()->setOrder('created_at', 'DESC'); //where update_time is `column_id`
