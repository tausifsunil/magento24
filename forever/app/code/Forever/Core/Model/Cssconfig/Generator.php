...
class Generator
{
    ...
    protected function generateStoreCss($type, $storeId)
    {
        ...
        try {
            $block = $this->layoutManager->createBlock('Forever\Core\Block\Template')->setData('area', 'frontend')->setTemplate($str4)->toHtml();
            ...
            $this->messageManager->addError(
                __('Failed generating CSS file: ' . $str2 . ' in ' . $this->cssconfigData->getCssConfigDir()) . '<br/>Message: ' . $e->getMessage()
            );
        }
